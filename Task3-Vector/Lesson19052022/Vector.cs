...
namespace Lesson19052022
{
    public class Vector
    {
        ...
        public void QuickSort1(int L, int R)
        {
            ...
            // Тут відрізняється від класичного розв'язку. Порівняйте з класичним. можем обговорити, якщо не
            if (L < j) QuickSort1(L, j);
            if (i < R) QuickSort1(i, R);
        }
        // слід передавати парметр, а не створювати 3 функції з практично однаковим кодом!!!!
